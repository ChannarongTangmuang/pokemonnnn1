...
const createModal = (pokemonData) => {
    ...
    ///ในการเพิ่มลายละเอียด ต้องเพิ่มตรงส่วนนี้ สามบรรทัก จะมีตัวอย่างให้ 
    ...
    ///const pokemonID = document.createElement("p");
    ///pokemonID.innerText = "ID : " + pokemonData.id;  ///ต้องเข้าไปหาเองว่าตัวเปลี่ยนของสิ่งที่อยากให้เเสดงคืออะไร หรืทจะแสดงแค่สองอันก็ได้ 
    ///modalBody.appendChild(pokemonID);
